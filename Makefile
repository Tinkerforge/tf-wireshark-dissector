...
# plugins/tfp/Makefile.  Generated from Makefile.in by configure.
...
# Makefile.common for tfp plugin
...
tfp_la_DEPENDENCIES =
am__objects_1 = packet-tfp.lo
am__objects_2 = $(am__objects_1)
am__objects_3 = $(am__objects_2)
am__objects_4 =
am__objects_5 = $(am__objects_4)
am_tfp_la_OBJECTS = plugin.lo $(am__objects_3) $(am__objects_5)
tfp_la_OBJECTS = $(am_tfp_la_OBJECTS)
AM_V_lt = $(am__v_lt_$(V))
am__v_lt_ = $(am__v_lt_$(AM_DEFAULT_VERBOSITY))
am__v_lt_0 = --silent
tfp_la_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) \
	$(LIBTOOLFLAGS) --mode=link $(CCLD) $(AM_CFLAGS) $(CFLAGS) \
	$(tfp_la_LDFLAGS) $(LDFLAGS) -o $@
...
SOURCES = $(tfp_la_SOURCES)
DIST_SOURCES = $(tfp_la_SOURCES)
...
YFLAGS = 
abs_builddir = /home/ishraq/wireshark-1.10.2/plugins/tfp
abs_srcdir = /home/ishraq/wireshark-1.10.2/plugins/tfp
...
tfp_la_LDFLAGS = -module -avoid-version
tfp_la_LIBADD = 
...
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am $(top_srcdir)/Makefile.am.inc $(srcdir)/Makefile.common $(srcdir)/../Makefile.common.inc $(am__configure_deps)
	...
	echo ' cd $(top_srcdir) && $(AUTOMAKE) --gnu plugins/tfp/Makefile'; \
	$(am__cd) $(top_srcdir) && \
	  $(AUTOMAKE) --gnu plugins/tfp/Makefile
.PRECIOUS: Makefile
...
tfp.la: $(tfp_la_OBJECTS) $(tfp_la_DEPENDENCIES) $(EXTRA_tfp_la_DEPENDENCIES) 
	$(AM_V_CCLD)$(tfp_la_LINK) -rpath $(plugindir) $(tfp_la_OBJECTS) $(tfp_la_LIBADD) $(LIBS)
